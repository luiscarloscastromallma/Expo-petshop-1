...
import com.example.alumno.myapplication.models.DetalleProducto2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent x = new Intent(Products.this, DetalleActivity.class);
                Products.this.startActivity(x);
        ...
        btnGo2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent x = new Intent(Products.this, DetalleProducto2.class);
                Products.this.startActivity(x);
        ...
        btnGo3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent x = new Intent(Products.this, Detalle3Activity.class);
                Products.this.startActivity(x);
        ...
        btnGo4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent x = new Intent(Products.this, Detalle4Activity.class);
                Products.this.startActivity(x);
