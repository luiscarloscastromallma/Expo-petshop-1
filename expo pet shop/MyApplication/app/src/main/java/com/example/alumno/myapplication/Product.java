    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent x = new Intent(Product.this, DetalleActivity.class);
                Product.this.startActivity(x);
        ...
        btnGo2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent x = new Intent(Product.this, Detalle2Activity.class);
                Product.this.startActivity(x);
        ...
        btnGo3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent x = new Intent(Product.this, Detalle3Activity.class);
                Product.this.startActivity(x);
        ...
        btnGo4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent x = new Intent(Product.this, Detalle4Activity.class);
                Product.this.startActivity(x);
